...
export function FramesIcon({ className = '', size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function ImageIcon({ className = '', size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function AlbumIcon({ className = '', size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function TransformIcon({ className = '', size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
